			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _("Trình Tải Ảnh") + '</div>' +
						'<div class="plupload_header_text">' + _("Hướng dẫn: Thêm ảnh vào rồi bấm nút tải lên.") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' + _('Name') + '</td>' +
				...
				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("Kéo ảnh vào đây.") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							...
							'<a class="plupload_button plupload_start">' + _("Tải Lên") + '</a>&nbsp;' +
	...
	*/
	...
	_handleState: function() {
		...
		if (up.total.queued === 0) {
			$('.ui-button-text', this.browse_button).html(_('Thêm Ảnh'));
		} else {
			$('.ui-button-text', this.browse_button).html(o.sprintf(_('Đã chọn %d ảnh, Thêm Ảnh '), up.total.queued));
		}
